...
public class DoCommit {
	...
	public static void main(String[] args) throws Exception {
		...
		// 要提交的文件
		File commitFile = new File("e:/svntest/wc/test.txt");
		...
		// 如果此文件不是新增加的，直接提交。
			...
			ourClientManager.getCommitClient().doCommit(new File[] { commitFile }, true, "add by svnkit.", null, null, true, false, SVNDepth.INFINITY);
